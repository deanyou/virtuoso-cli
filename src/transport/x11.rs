...
pub fn dismiss(
    ...
    // Helper emits one JSON object per line. The first batch is dialogs found;
    // any line with a "dismissed" key is a dismiss record.
    ...
    for line in out.stdout.lines() {
        ...
        // Non-dialog JSON ({"error": "..."}); capture it.
